...
const result = await build({ stdin: {
  contents: "import {loadLocalContentBundle} from './backend/membership-content-source.ts'; import {practiceTestModules} from './src/content/practiceTests.ts'; export default {modules:practiceTestModules,scenarios:loadLocalContentBundle().scenarioItems,codeItems:loadLocalContentBundle().codeItems};",
