...
Home offers two daily challenges: two completed sessions (60 XP), and 20 correct answers (80 XP). Weekly challenges reward ten completed sessions (250 XP), and practice on three distinct days (200 XP). A session needs at least five answered questions in recorded practice tests or solo games. Opening or abandoning a game does not count. Flashcard browsing and bot warmups do not count toward these particular session challenges.
