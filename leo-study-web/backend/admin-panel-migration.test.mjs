...
test('owner admin panel migration records audit events for member actions', () => {
  for (const eventType of ['owner_create_class', 'owner_set_member_role', 'owner_remove_member', 'owner_timeout_member']) {
